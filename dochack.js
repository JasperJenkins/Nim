...
function is_whitespace_196639(text_196641) {
		     return !/[^\s]/.test(text_196641);
  

	
}

function is_whitespace_196656(x_196658) {
		var Tmp1;
		var Tmp2;

	var result_196659 = false;

	var F={procname:"dochack.isWhitespace",prev:framePtr,filename:"dochack.nim",line:0};
	framePtr = F;
		F.line = 134;
		if (!(x_196658.nodeName == "#text")) Tmp2 = false; else {			Tmp2 = is_whitespace_196639(x_196658.textContent);		}		if (Tmp2) Tmp1 = true; else {			Tmp1 = (x_196658.nodeName == "#comment");		}		result_196659 = Tmp1;
	framePtr = F.prev;
...
function to_toc_196673(x_196675, father_196676) {
								var Tmp5;
						var Tmp6;
						var Tmp7;
						var Tmp8;
	...
	framePtr = F;
		if ((x_196675.nodeName == "UL")) {
		F.line = 139;
		var f_196695 = {heading: null, kids: [], sortId: (father_196676.kids != null ? father_196676.kids.length : 0), doSort: false};
		F.line = 140;
		var i_196697 = 0;
		L1: do {
			F.line = 141;
				L2: while (true) {
				if (!(i_196697 < x_196675.childNodes.length)) break L2;
					F.line = 142;
					var nxt_196698 = addInt(i_196697, 1);
					L3: do {
						F.line = 143;
							L4: while (true) {
								if (!(nxt_196698 < x_196675.childNodes.length)) Tmp5 = false; else {									Tmp5 = is_whitespace_196656(x_196675.childNodes[nxt_196698]);								}							if (!Tmp5) break L4;
								F.line = 144;
								nxt_196698 = addInt(nxt_196698, 1);
							}
					} while(false);
						if (!(nxt_196698 < x_196675.childNodes.length)) Tmp8 = false; else {							Tmp8 = (x_196675.childNodes[i_196697].nodeName == "LI");						}						if (!Tmp8) Tmp7 = false; else {							Tmp7 = (x_196675.childNodes[i_196697].childNodes.length == 1);						}						if (!Tmp7) Tmp6 = false; else {							Tmp6 = (x_196675.childNodes[nxt_196698].nodeName == "UL");						}					if (Tmp6) {
					F.line = 147;
					var e_196723 = {heading: x_196675.childNodes[i_196697].childNodes[0], kids: [], sortId: (f_196695.kids != null ? f_196695.kids.length : 0), doSort: false};
					F.line = 148;
					var it_196724 = x_196675.childNodes[nxt_196698];
					L9: do {
						F.line = 149;
						var j_196731 = 0;
						F.line = 2638;
						...
						F.line = 149;
						colontmp__197432 = it_196724.childNodes.length;
						F.line = 2639;
						var i_197433 = 0;
						L10: do {
							F.line = 2640;
								...
								if (!(i_197433 < colontmp__197432)) break L11;
									...
									j_196731 = i_197433;
									F.line = 150;
									to_toc_196673(it_196724.childNodes[j_196731], e_196723);
									F.line = 2642;
					...
					F.line = 151;
					if (f_196695.kids != null) { f_196695.kids.push(e_196723); } else { f_196695.kids = [e_196723]; };
					F.line = 152;
					i_196697 = addInt(nxt_196698, 1);
					}
					else {
						F.line = 154;
						to_toc_196673(x_196675.childNodes[i_196697], f_196695);
						F.line = 155;
						i_196697 = addInt(i_196697, 1);
					}
					
				}
		} while(false);
		F.line = 156;
		if (father_196676.kids != null) { father_196676.kids.push(f_196695); } else { father_196676.kids = [f_196695]; };
		}
		else {
		if (is_whitespace_196656(x_196675)) {
		}
		else {
		if ((x_196675.nodeName == "LI")) {
		F.line = 160;
		var idx_196766 = [];
		L12: do {
			F.line = 161;
			...
			F.line = 161;
			colontmp__197437 = x_196675.childNodes.length;
			F.line = 2639;
			var i_197438 = 0;
			L13: do {
				F.line = 2640;
					...
					if (!(i_197438 < colontmp__197437)) break L14;
						F.line = 161;
						i_196773 = i_197438;
						if (!(is_whitespace_196656(x_196675.childNodes[i_196773]))) {
						F.line = 162;
						if (idx_196766 != null) { idx_196766.push(i_196773); } else { idx_196766 = [i_196773]; };
						}
			...
			if (!((idx_196766 != null ? idx_196766.length : 0) == 2)) Tmp15 = false; else {				Tmp15 = (x_196675.childNodes[idx_196766[chckIndx(1, 0, idx_196766.length+0-1)-0]].nodeName == "UL");			}		if (Tmp15) {
		F.line = 164;
		var e_196804 = {heading: x_196675.childNodes[idx_196766[chckIndx(0, 0, idx_196766.length+0-1)-0]], kids: [], sortId: (father_196676.kids != null ? father_196676.kids.length : 0), doSort: false};
		F.line = 166;
		var it_196805 = x_196675.childNodes[idx_196766[chckIndx(1, 0, idx_196766.length+0-1)-0]];
		L16: do {
			F.line = 167;
			var j_196812 = 0;
			F.line = 2638;
			...
			F.line = 167;
			colontmp__197443 = it_196805.childNodes.length;
			F.line = 2639;
			var i_197444 = 0;
			L17: do {
				F.line = 2640;
					...
					if (!(i_197444 < colontmp__197443)) break L18;
						...
						j_196812 = i_197444;
						F.line = 168;
						to_toc_196673(it_196805.childNodes[j_196812], e_196804);
						F.line = 2642;
		...
		F.line = 169;
		if (father_196676.kids != null) { father_196676.kids.push(e_196804); } else { father_196676.kids = [e_196804]; };
		}
		else {
			L19: do {
				F.line = 171;
				...
				F.line = 171;
				colontmp__197448 = x_196675.childNodes.length;
				F.line = 2639;
				var i_197449 = 0;
				L20: do {
					F.line = 2640;
						...
						if (!(i_197449 < colontmp__197448)) break L21;
							...
							i_196826 = i_197449;
							F.line = 172;
							to_toc_196673(x_196675.childNodes[i_196826], father_196676);
							F.line = 2642;
			...
			F.line = 174;
		if (father_196676.kids != null) { father_196676.kids.push({heading: x_196675, kids: [], sortId: (father_196676.kids != null ? father_196676.kids.length : 0), doSort: false}); } else { father_196676.kids = [{heading: x_196675, kids: [], sortId: (father_196676.kids != null ? father_196676.kids.length : 0), doSort: false}]; };
		}
		}}
	framePtr = F.prev;
...
function uncovered_196920(x_196922) {
			var Tmp1;
		var Tmp2;

	var result_196923 = null;

	var F={procname:"dochack.uncovered",prev:framePtr,filename:"dochack.nim",line:0};
	framePtr = F;
	BeforeRet: do {
			if (!((x_196922.kids != null ? x_196922.kids.length : 0) == 0)) Tmp1 = false; else {				Tmp1 = !((x_196922.heading == null));			}		if (Tmp1) {
		F.line = 194;
		if (!(x_196922.heading.hasOwnProperty('__karaxMarker__'))) {
		Tmp2 = x_196922;
		}
		else {
		Tmp2 = null;
		...
		F.line = 195;
		result_196923 = {heading: x_196922.heading, kids: [], sortId: x_196922.sortId, doSort: x_196922.doSort};
		L3: do {
			F.line = 197;
			var i_196961 = 0;
			F.line = 2638;
			...
			F.line = 197;
			colontmp__197508 = (x_196922.kids != null ? x_196922.kids.length : 0);
			F.line = 2639;
			var i_197509 = 0;
			L4: do {
				F.line = 2640;
					...
					if (!(i_197509 < colontmp__197508)) break L5;
						...
						i_196961 = i_197509;
						F.line = 198;
						var y_196962 = uncovered_196920(x_196922.kids[chckIndx(i_196961, 0, x_196922.kids.length+0-1)-0]);
						if (!((y_196962 == null))) {
						F.line = 199;
						if (result_196923.kids != null) { result_196923.kids.push(y_196962); } else { result_196923.kids = [y_196962]; };
						}
		...
		if (((result_196923.kids != null ? result_196923.kids.length : 0) == 0)) {
		F.line = 200;
		result_196923 = null;
		}
	...
	return result_196923;

}

function merge_tocs_196996(orig_196998, news_196999) {
	var result_197000 = null;

	var F={procname:"dochack.mergeTocs",prev:framePtr,filename:"dochack.nim",line:0};
	framePtr = F;
		F.line = 203;
		result_197000 = uncovered_196920(orig_196998);
		if ((result_197000 == null)) {
		F.line = 205;
		result_197000 = news_196999;
		}
		else {
			L1: do {
				F.line = 207;
				...
				F.line = 207;
				colontmp__197502 = (news_196999.kids != null ? news_196999.kids.length : 0);
				F.line = 2639;
				var i_197503 = 0;
				L2: do {
					F.line = 2640;
						...
						if (!(i_197503 < colontmp__197502)) break L3;
							...
							i_197020 = i_197503;
							F.line = 208;
							if (result_197000.kids != null) { result_197000.kids.push(news_196999.kids[chckIndx(i_197020, 0, news_196999.kids.length+0-1)-0]); } else { result_197000.kids = [news_196999.kids[chckIndx(i_197020, 0, news_196999.kids.length+0-1)-0]]; };
							F.line = 2642;
	...
	return result_197000;

}

function build_toc_197041(orig_197043, types_197045, procs_197046) {
	var result_197047 = null;

	var F={procname:"dochack.buildToc",prev:framePtr,filename:"dochack.nim",line:0};
	framePtr = F;
		F.line = 211;
		var new_stuff_197061 = {heading: null, kids: [], doSort: true, sortId: 0};
		L1: do {
			F.line = 212;
			var t_197214 = null;
			F.line = 156;
			var i_197491 = 0;
			F.line = 157;
			var l_197492 = (types_197045 != null ? types_197045.length : 0);
			L2: do {
				F.line = 158;
					L3: while (true) {
					if (!(i_197491 < l_197492)) break L3;
						F.line = 212;
						t_197214 = types_197045[chckIndx(i_197491, 0, types_197045.length+0-1)-0];
						F.line = 213;
						...
						L4: do {
							...
							var i_197488 = 0;
							F.line = 157;
							var l_197489 = (procs_197046 != null ? procs_197046.length : 0);
							L5: do {
								F.line = 158;
									L6: while (true) {
									if (!(i_197488 < l_197489)) break L6;
										F.line = 215;
										p_197235 = procs_197046[chckIndx(i_197488, 0, procs_197046.length+0-1)-0];
										...
										if (!(((procs_197046 != null ? procs_197046.length : 0) == l_197489))) {
										F.line = 161;
						...
						F.line = 224;
						if (new_stuff_197061.kids != null) { new_stuff_197061.kids.push(c_197228); } else { new_stuff_197061.kids = [c_197228]; };
						F.line = 160;
						i_197491 = addInt(i_197491, 1);
						if (!(((types_197045 != null ? types_197045.length : 0) == l_197492))) {
						F.line = 161;
						failed_assert_impl_55855(makeNimstrLit("/Users/travis/build/nim-lang/Nim/lib/system/iterators.nim(161, 11) `len(a) == L` seq modified while iterating over it"));
						}
		...
		F.line = 225;
		result_197047 = merge_tocs_196996(orig_197043, new_stuff_197061);
	framePtr = F.prev;

	return result_197047;
...
function togglevis_197314(d_197316) {
	var F={procname:"dochack.togglevis",prev:framePtr,filename:"dochack.nim",line:0};
	framePtr = F;
		F.line = 230;
		    if (d_197316.style.display == 'none')
      d_197316.style.display = 'inline';
    else
      d_197316.style.display = 'none';
...
function groupBy(value_197332) {
	var F={procname:"dochack.groupBy",prev:framePtr,filename:"dochack.nim",line:0};
	framePtr = F;
		F.line = 238;
		var toc_197333 = document.getElementById("toc-list");
		if ((alternative_197300[0] == null)) {
		F.line = 240;
		var tt_197352 = {heading: null, kids: [], sortId: 0, doSort: false};
		F.line = 241;
		to_toc_196673(toc_197333, tt_197352);
		F.line = 242;
		tt_197352 = tt_197352.kids[chckIndx(0, 0, tt_197352.kids.length+0-1)-0];
		F.line = 244;
		var types_197367 = [[]];
		F.line = 245;
		var procs_197382 = [[]];
		F.line = 247;
		extract_items_196337(tt_197352, "Types", types_197367, 0);
		F.line = 248;
		extract_items_196337(tt_197352, "Procs", procs_197382, 0);
		F.line = 249;
		extract_items_196337(tt_197352, "Converters", procs_197382, 0);
		F.line = 250;
		extract_items_196337(tt_197352, "Methods", procs_197382, 0);
		F.line = 251;
		extract_items_196337(tt_197352, "Templates", procs_197382, 0);
		F.line = 252;
		extract_items_196337(tt_197352, "Macros", procs_197382, 0);
		F.line = 253;
		extract_items_196337(tt_197352, "Iterators", procs_197382, 0);
		F.line = 255;
		var ntoc_197390 = build_toc_197041(tt_197352, types_197367[0], procs_197382[0]);
		F.line = 256;
		var x_197391 = to_html_196420(ntoc_197390, true);
		F.line = 257;
		alternative_197300[0] = tree_196020(makeNimstrLit("DIV"), [x_197391]);
		}
		
		if ((value_197332 == "type")) {
		F.line = 259;
		replace_by_id_196172("tocRoot", alternative_197300[0]);
		}
		else {
			F.line = 261;
		...
		F.line = 262;
		togglevis_197314(document.getElementById("toc-list"));
	framePtr = F.prev;
...
function fuzzy_match_195070(pattern_195072, str_195073) {
	...
	framePtr = F;
		...
		F.line = 136;
		nimCopy(result_195077, {Field0: nimMax(0, score_195089), Field1: (0 < score_195089)}, NTI195074);
	framePtr = F.prev;
